<div class="my_sidebar position-fixed">
    <div class="list-group">
        ...
        <a href="/consultations/1" class="list-group-item list-group-item-action py-3 {{Request::is('consultations') || Request::is('consultations/*') ? 'active' : ''}}">
        ...
        <a href="/account" class="list-group-item list-group-item-action py-3 {{Request::is('account') || Request::is('account/*') ? 'active' : ''}}">
