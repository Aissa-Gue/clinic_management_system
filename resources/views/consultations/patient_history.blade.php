...
@section('content')
    ...
    <fieldset class="scheduler-border">
        ...
        <div class="row mt-5">
            <div class="col-md-6">
                <p><span class="fw-bold">Patient: </span>{{$currentApp->patient->first_name}} {{$currentApp->patient->last_name}}</p>
            </div>
            <div class="col-md-6">
                <p><span class="fw-bold">Doctor: </span>{{$currentApp->doctor->first_name}} {{$currentApp->doctor->last_name}}</p>
            </div>
            <div class="col-md-6">
                <p><span class="fw-bold">Birthdate: </span>{{$currentApp->patient->birthdate}} / {{\Carbon\Carbon::parse($currentApp->patient->birthdate)->age}} years old</p>
            </div>
            <div class="col-md-6">
                <p><span class="fw-bold">Speciality: </span>{{$currentApp->doctor->speciality}}</p>
            </div>
        </div>
    </fieldset>
